...
// #if defined(HELTEC_WIRELESS_STICK_LITE_V3) || defined(HELTEC_WIRELESS_STICK_V3) || defined(HELTEC_LORA32_V3) || defined(NM_BOT_CHAIN_V1) || defined(HELTEC_WIFI_KIT_32_V3)
...
#ifdef LILYGO_T_DISPLAY_S3_AMOLED
#include <User_Setups/Setup218_LilyGo_T_Display_S3_AMOLED.h>     // For the LilyGo T-Display S3 AMOLED based ESP32S3 with ST7789 170 x 320 TFT
#endif

#ifdef ESP32_2432S028R_7789
#include <User_Setups/Setup216_ST7789_2432S028R.h>     
#endif

#ifdef ESP32_2432S028R_9341
#include <User_Setups/Setup216_ILI9341_2432S028R.h>     
#endif

#ifdef ESP32_3248S035
#include <User_Setups/Setup219_ST7789_3248S035.h>     
#endif

#ifdef ESP32_2432S024
#include <User_Setups/Setup220_ST7789_2432S024.h>
#endif


#ifdef LILYGO_T_DONGLE_S3
#include <User_Setups/Setup209_LilyGo_T_Dongle_S3.h>     // For the LilyGo T-Display S3 based ESP32S3 with ST7789 170 x 320 TFT
#endif
...
#include <User_Setups/Setup214_Heltec_vision_master_t190.h>
#endif
#ifdef NM_USB_CHAIN_V1
#include <User_Setups/Setup215_NM_usb_chain_v1.h>
#endif
#ifdef TTGO_T_DISPLAY
#include <User_Setups/Setup25_TTGO_T_Display.h>
#endif
#ifdef ESP32_S3_GEEK
#include <User_Setups/Setup252_ESP32_S3_GEEK.h>
#endif
#ifdef NM_TV_154
#include <User_Setups/Setup217_NM_TV_154.h>
#endif
#ifdef WT32_SC01
#include <User_Setups/Setup303_WT32_SC01.h>
#endif
